...
<html>
<head>
	<title>About-HelloBizer</title>
	<meta name="viewport" content="width=device-width">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="stylesheet" type="{{asset('Frontend')}}/text/css" href="css/all.css">
	<link rel="stylesheet" type="{{asset('Frontend')}}/text/css" href="css/all.min.css">
	<link rel="stylesheet" type="{{asset('Frontend')}}/text/css" href="css/lightbox.css">
	<link rel="stylesheet" type="{{asset('Frontend')}}/text/css" href="css/flexslider.css">
	<link rel="stylesheet" type="{{asset('Frontend')}}/text/css" href="css/owl.carousel.css">
	<link rel="stylesheet" type="{{asset('Frontend')}}/text/css" href="css/owl.theme.default.css">
	<link rel="stylesheet" type="{{asset('Frontend')}}/text/css" href="css/jquery.rateyo.css"/>
		...
		<section class="whyUs-section">
			<div class="container">
				<div class="featured-points">
					<ul>
						<li><i class="fas fa-book"></i> Good Behavio with Tourist</li>
